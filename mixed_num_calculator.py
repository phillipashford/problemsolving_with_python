# Write a program that prompts the user to enter both the numerator and denominator of an improper fraction. Use an f_string to express the improper fraction as a mixed number.
# Example Output
